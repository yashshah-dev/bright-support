            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {services.map((service, index) => (
                  <div key={index} className="flex items-start gap-3 bg-white p-6 rounded-2xl shadow-elegant border border-slate-100 hover:border-indigo-200 hover:shadow-elegant-lg transition-all duration-300">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {features.map((feature, index) => (
                  <div key={index} className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-8 shadow-elegant border border-indigo-100 hover:shadow-elegant-lg hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="space-y-8">
                {process.map((step, index) => (
                  <div key={index} className="flex gap-6">
                    <div className="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-2xl flex items-center justify-center font-bold text-xl shadow-elegant">
                      {step.step}
                    </div>
